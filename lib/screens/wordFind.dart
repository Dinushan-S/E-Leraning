...
class _WordFindState extends State<WordFind> {
  ...
  void initState() {
    ...
    listQuestions = [
      WordFindQues(
        question: "What is name of this music instruments?",
        answer: "guitar",
        pathImage:
            "https://www.collinsdictionary.com/images/full/guitar_129991187.jpg",
      ),
      WordFindQues(
      ...
      WordFindQues(
        question: "What is the name of the tourist place in srilanka?",
        answer: "Sigiriya",
        pathImage:
                  ...
                  children: currentQues.puzzles.map((puzzle) {
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        ...
                        width: constraints.biggest.width / 9 - 6,
